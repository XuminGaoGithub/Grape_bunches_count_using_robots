...
class DataAugmentForObjectDetection():
    def __init__(self, rotation_rate=0.5, max_rotation_angle=30,
                 ...
                 cutout_rate=0.5, cut_out_length=100, cut_out_holes=1, cut_out_threshold=0.5):
...
source_pic_root_path = '/home/xumin/catkin_ws/src/darknet_ros/darknet/data/voc2007/JPEGImages/'
source_xml_root_path = '/home/xumin/catkin_ws/src/darknet_ros/darknet/data/voc2007/Annotations'
img_save_path = '/home/xumin/catkin_ws/src/darknet_ros/darknet/data/voc2007/aug_image/'
save_dir = '/home/xumin/catkin_ws/src/darknet_ros/darknet/data/voc2007/aug_xml/'
...
for parent, _, files in os.walk(source_pic_root_path):
    for file in files:
        ...
        while cnt < need_aug_num:
            ...
            cnt += 1
            cv2.imwrite(img_save_path+file[:-4]+'_4.jpg',auged_img)
            save_xml(file[:-4]+'_4.jpg',labels,auged_bboxes,file_dir = img_save_path,save_dir=save_dir)
