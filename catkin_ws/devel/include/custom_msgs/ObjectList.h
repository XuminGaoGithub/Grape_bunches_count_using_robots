...
struct ObjectList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::custom_msgs::WorldObject_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::custom_msgs::WorldObject_<ContainerAllocator> >::other >  _objects_type;
